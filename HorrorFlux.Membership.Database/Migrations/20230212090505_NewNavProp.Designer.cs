...
namespace HorrorFlux.Membership.Database.Migrations
{
    ...
    [Migration("20230212090505_NewNavProp")]
    partial class NewNavProp
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HorrorFlux.Membership.Database.Entities.Film", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Free = true,
                            Release = new DateTime(2014, 4, 2, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("HorrorFlux.Membership.Database.Entities.FilmGenre", b =>
                {
                    b.HasOne("HorrorFlux.Membership.Database.Entities.Film", null)
                        .WithMany()
                        .HasForeignKey("FilmId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HorrorFlux.Membership.Database.Entities.Genre", null)
                        .WithMany()
            ...
            modelBuilder.Entity("HorrorFlux.Membership.Database.Entities.SimilarFilms", b =>
                {
                    b.HasOne("HorrorFlux.Membership.Database.Entities.Film", "ParentFilm")
