        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, "A group of intergalactic criminals must pull together to stop a fanatical warrior with plans to purge the universe.", 1, "/MoviePoster/Guardian Of The Galaxy.png", "https://www.youtube.com/watch?v=d96cjJhvlMA", true, new DateTime(2014, 4, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), "Guardian Of the Galaxy" }
                });
